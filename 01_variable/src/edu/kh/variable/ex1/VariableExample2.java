...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		booleanData = true;
		// = : 대입연산자 ==> 오른쪽에 있는 값을 왼쪽에 대입하겠다. 라는 의미
	     ...
	     * */
	     ...
	     long longNumber = 10000000000L;  // 대소문자 상관없이 long 사용시 L을 써야함 
	     // The literal 10000000000 of type int is out of range
	     // 100억 이라는 값은 범위를 벗어남
	     // 뒤에 L을 붙여줌으로써  long자료형인것을 나타냄
	     
	     // 실수형
	     float floatNumber = 1.2345f;    // 대소문자 상관없이 float 사용시 F을 써야함
	     
	     double doubleNumber = 3.141592;
	     //d를 뒤에 쓸 수는 있다. => 3.141592d;
	     //실수형은 float, double 두 개 밖에 없기 때문에
	     //자바는 double을 리터렬 안붙이고 쓰는애로 정함.
