...
// [접근제한자] [예약어] class명	 // 클래스라고 쓰는건 다 객체로 쓰겠다는 내용임

// 접근제한자 public : 같은 프로젝트 내에서 어떤 클래스에서든 import 할 수 있음을 나타냄.
	
	// 필드(field) : 객체의 속성을 작성하는 클래스 내부 영역
	// 멤버 변수 : 메서드 밖에 작성된 변수
	//		1) 인스턴스 변수 : 필드에 작성되는 일반 변수 (객체 미 생성시 사용 불가)
	//		2) 클래스 변수(==static변수) : 필드에 static 예약어가 작성된 변수 (객체 생성 안해도 쓸 수 있음)
	...
	protected int v2 = 20;
	int v3 = 30;
	// 특별한 경우가 아니면 private 사용 / 이건 default
	private int v4= 40;
	...
	public String name; //캡슐화 원칙 private -> 간접접근방법이 필요
	
	{
		//초기화 불록 : 객체 생성시 필드 값 초기화
		name = "홍길동";
	}
