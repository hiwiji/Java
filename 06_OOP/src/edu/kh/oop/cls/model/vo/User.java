...
public class User {
	...
	public User(String usedId, String userPw) {
					 //"test33"  "pwrd23r23"
	...
	public User (String usedId, String userPw, String userName, int userAge, char userGender) {
	...
	public String getUserId() {  // userId의 getter
	         //(String은 반환할 값의 자료형을 쓰는거임 )
		return userId;
	}
	
	public void setUserId(String userId) { //usedID의 setter
		this.userId = userId;
	}
