...
public class ExceptionService {
	...
	public int inputNumber() {
		...
		while(true) {
			...
			}catch(InputMismatchException e) {   //InputMismatchException 인포트 해주기
				System.out.println("<잘못 입력하셨습니다. 정수만 입력하세요");
				sc.nextLine(); // 버퍼에 남아있는 잘못 입력된 문자열 제거
								// 이거(sc.nextLine) 입력 안하면 while문이 true 일 때 동안 무한으로 돔 
				}
		}
	...
	public void ex3() {
		...
		try {
			...
			System.out.print("정수 입력1 : "); //정수가 아닌수 입력하는 InputMismatchException
			int num1 = sc.nextInt();
		
			System.out.print("정수 입력2 : ");  //InputMismatchException
			int num2 = sc.nextInt();

			System.out.println("나누기 결과 : " + num1 / num2); //ArtithmeticException
	...
	public void ex4() {
		...
		try {
		 ...
		 //arith 쓰고 ctrl + 스페이스바 치면 자동완성 
			...
			System.out.println(equals(e)   ); // e.toString();
	...
	public void methodD() {
		...
		// - 프로그램 수행 중 
		//   개발자의 코딩 실 수 또는 사용자의 잘못된 값 입력으로
		//   흔하게 발생할 수 있는 예외
